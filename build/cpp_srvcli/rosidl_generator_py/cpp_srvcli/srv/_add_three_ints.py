...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cpp_srvcli')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cpp_srvcli.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from cpp_srvcli.srv._add_three_ints import AddThreeInts_Request as Request
    from cpp_srvcli.srv._add_three_ints import AddThreeInts_Response as Response
