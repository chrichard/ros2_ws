...
#include "cpp_srvcli/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cpp_srvcli::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_srvcli::msg::Sphere & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const cpp_srvcli::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_srvcli::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &cpp_srvcli::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_srvcli, msg, Sphere)() {
  return &cpp_srvcli::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
