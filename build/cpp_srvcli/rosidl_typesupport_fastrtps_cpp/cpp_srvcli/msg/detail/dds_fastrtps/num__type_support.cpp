...
#include "cpp_srvcli/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const cpp_srvcli::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_srvcli::msg::Num *>(
    untyped_ros_message);
...
{
  return &cpp_srvcli::msg::typesupport_fastrtps_cpp::_Num__handle;
}
