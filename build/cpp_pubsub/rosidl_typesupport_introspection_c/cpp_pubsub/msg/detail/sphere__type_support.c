...
#include <stddef.h>
#include "cpp_pubsub/msg/detail/sphere__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Sphere__rosidl_typesupport_introspection_c__Sphere_message_member_array[2] = {
  {
    ...
    offsetof(cpp_pubsub__msg__Sphere, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_pubsub__msg__Sphere, radius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Sphere__rosidl_typesupport_introspection_c__Sphere_message_members = {
  ...
  "Sphere",  // message name
  2,  // number of fields
  sizeof(cpp_pubsub__msg__Sphere),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_pubsub, msg, Sphere)() {
