...
#include "cpp_pubsub/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const cpp_pubsub::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_pubsub::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &cpp_pubsub::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
